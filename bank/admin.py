...
from .models import All_Customer,Chit_Batches,Saving_Customer,Credit_Customer,Chit_Fund_Customer,Savings_Customer_Savings,Credit_Customer_Credit
...
class Saving_CustomerAdmin(admin.ModelAdmin):
    list_display = ('Sl_No','Date_Credited','Name','Account_No','Total_Savings')
